...
<html>
	<head>
		...
		<link rel="stylesheet" href="assets/css/certificaciones.css" />
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
                    ...
                    <section>
                        <!-- Mini Posts -->
								<div class="certificado-posts">

									<!-- Mini Post -->
										<article class="certificado-post">
											<header>
												<h3><a href="single.html">Suut</a></h3>
												<p class="published">Proyecto sustentable...</p>
												<a href="#" class="author"><img src="images/alex.png" alt="" /></a>
											</header>
											<a href="single.html" class="image"><img src="images/suut.png" alt="" /></a>
										</article>
									...
									<!-- Mini Post -->
										<article class="certificado-post">
											<header>
												...
												<p class="published">Inteligencia Artificial...</p>
									...
									<!-- Mini Post -->
										<article class="certificado-post">
											<header>
												<h3><a href="single.html">Brazo Robotico</a></h3>
												<p class="published">Robotica...</p>
												<a href="#" class="author"><img src="images/alan.jpg" alt="" /></a>
											</header>
											<a href="single.html" class="image"><img src="images/brazorobotico.jpg" alt="" /></a>
										</article>

									<!-- Mini Post -->
										<article class="certificado-post">
											<header>
												<h3><a href="single.html">Google.com</a></h3>
												<p class="published">Red Social...</p>
												<a href="#" class="author"><img src="images/jaret.png" alt="" /></a>
											</header>
											<a href="single.html" class="image"><img src="images/google.png" alt="" /></a>
										</article>
