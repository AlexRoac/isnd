			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						...
						<!-- Post -->
						<!-- ESTA SON COSAS QUE PODEMOS USAAAAAAAAAAAAAAAAAAAAAR
							<article class="post">
								<header>
									<div class="title">
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
		...
		<!-- Scripts -->
			...
			<style>/* Estilos para la ventana modal */
				.modal {
					display: none; /* Oculta la modal por defecto */
					position: fixed; /* Fija la posición */
					z-index: 1; /* Asegura que la modal esté por encima de otros elementos */
					left: 0;
					top: 0;
					width: 100%;
					height: 100%;
